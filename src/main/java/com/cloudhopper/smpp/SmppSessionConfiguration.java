...
public class SmppSessionConfiguration extends SmppConnectionConfiguration {
	 ...
	 *
	 * @param windowWaitTimeout The amount of time to wait (in ms) until a slot in the sendWindow becomes available.
	 */
	...
	/**
	 * Set the amount of time to wait for an endpoint to respond to a request before it expires. Defaults to disabled
	 * (-1).
	 *
	 * @param requestExpiryTimeout The amount of time to wait (in ms) before an unacknowledged request expires. -1
	 * disables.
	 */
	...
	/**
	 * Sets the amount of time between executions of monitoring the window for requests that expire. It's recommended
	 * that this generally either matches or is half the value of requestExpiryTimeout. Therefore, at worst a request
	 * would could take up 1.5X the requestExpiryTimeout to clear out.
	 *
	 * @param windowMonitorInterval The amount of time to wait (in ms) between executions of monitoring the window.
	 */
